...
export default function Pricing() {
  ...
  return (
    <div className="flex-1 overflow-y-auto bg-slate-50 pb-6">
      <div className="bg-white border-b border-slate-100 px-4 sm:px-8 sm:px-6 py-5"><h1 className="text-lg sm:text-xl font-bold text-slate-800">Pricing</h1><p className="text-sm text-slate-400">Choose the right plan for your coaching business</p></div>
      <div className="px-4 sm:px-8 sm:px-6 py-8 max-w-5xl mx-auto grid grid-cols-1 sm:grid-cols-3 md:grid-cols-3 gap-6">
        {plans.map((plan) => (
