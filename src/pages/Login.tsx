...
export default function Login() {
  ...
  return (
    <div
      className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex"
        ...
        <div className="relative z-10 space-y-3">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="text-slate-300 text-sm italic leading-relaxed">
                  "CoachOS transformed how I manage 30+ clients. The adherence score alone saves me 5 hours a week of manual tracking."
                </p>
          ...
          <div className="flex items-center gap-4 px-1">
            ...
            <div className="text-center">
              ...
              <p className="text-xs text-slate-500">Clients tracked</p>
            </div>
            <div className="w-px h-8 bg-slate-700" />
            <div className="text-center">
              <p className="text-2xl font-bold text-emerald-400">83%</p>
              <p className="text-xs text-slate-500">Avg adherence</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-white rounded-3xl shadow-2xl p-8">
            ...
            <p className="text-sm text-slate-400 mb-6">
              {mode === "login"
                ? "Sign in to your CoachOS dashboard"
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              {mode === "signup" && (
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full px-3.5 py-2.5 text-sm border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-400 transition-colors"
                  />
                </div>
              )}
              <div>
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    required
                    minLength={6}
                    className="w-full px-3.5 py-2.5 pr-10 text-sm border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-400 transition-colors"
                  />
                  <button
                    type="button"
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-emerald-500 hover:bg-emerald-600 disabled:opacity-60 text-white py-3 rounded-xl text-sm font-semibold transition-all duration-200 flex items-center justify-center gap-2 shadow-lg shadow-emerald-500/20"
              >
                {loading ? (
            ...
            <div className="mt-4">
              ...
              <button
                ...
                disabled={loading}
                className="w-full border border-slate-200 hover:border-slate-300 hover:bg-slate-50 text-slate-600 py-2.5 rounded-xl text-sm font-medium transition-all"
              >
